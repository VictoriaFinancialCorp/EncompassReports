...
namespace ReportFunded
{
    class Locks4CTCNotFundedReport
    {
        ...
        private String startApplication()
        {
            ...
            cri2.FieldName = "Fields.Log.MS.Date.Clear to Close";
            cri2.Value = DateFieldCriterion.NonEmptyDate;  
            cri2.MatchType = OrdinalFieldMatchType.Equals;
         
            //empty funding date
            DateFieldCriterion cri3 = new DateFieldCriterion();
            cri3.FieldName = "Fields.Log.MS.Date.Funding";
            cri3.Value = DateFieldCriterion.EmptyDate;
            cri3.MatchType = OrdinalFieldMatchType.Equals;
            ...
            QueryCriterion fullQuery = folderCri.And((cri2).And(cri3));
